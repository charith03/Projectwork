...
public class SecurityConfig {
	...
	public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception{
		...
		.authorizeHttpRequests(request -> request.requestMatchers("/admin-page")
				...
				.requestMatchers("/registration", "/css/**", "/images/**", "/js/**", "/assets/**", "/img/**", "/about", "/contact", "/menu", "/service", "/event", "/404", "/grid", "/buttons", "/home", "/cart", "/checkout", "/restaurant6", "/restaurant5", "/restaurant4", "/restaurant3", "/restaurant2", "/restaurant1", "/check", "/saveCheckoutForm", "/transaction").permitAll()
